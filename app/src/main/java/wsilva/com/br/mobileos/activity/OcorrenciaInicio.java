 ...
 */
public class OcorrenciaInicio extends CoreFragmentActivity implements IOcorrenciaInicio
{
    ...
    {
        Log.w("$$$", "OcorrenciaInicio>onSalvar");
        if (Fachada.inserirOcorrencia(OcorrenciaInicio.this, interrupcao))
        {
            Util.createAlertDialog(OcorrenciaInicio.this,
    ...
    protected void init(Bundle savedInstanceState)
    {
        ...
        if (findViewById(R.id.pager)!=null)
        {
            ...
            OcorrenciaInicioFragment fragment = new OcorrenciaInicioFragment();
    ...
    protected void doOK()
    {
        OcorrenciaInicioFragment fragment =  (OcorrenciaInicioFragment)
    ...
    protected void alterarSubtitulo()
    {
        ...
        lblSubtitulo.setText(getResources().getText(R.string.lbl_interrupcao_inicio_titulo).toString());
    }
}
