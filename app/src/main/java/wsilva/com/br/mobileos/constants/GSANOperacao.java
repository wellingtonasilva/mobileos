...
public class GSANOperacao
{
	...
	/**USUÁRIO EFETUAR ALTERAÇÃO SENHA**/
	...
	/**USUÁRIO CONTROLAR ACESSO - PERMISS�ES ESPECIAIS**/
	...
	/** EFETUAR MUDAN�A DE SITUA��O DE FATURAMENTO DA LIGAÇÃO DE ESGOTO */
	...
	public static final Integer OPERACAO_CANCELAR_IMOVEL_DOACAO = new Integer(
			293);
	/** VALOR COBRAN�A SERVI�O INSERIR */
	...
	public static final Integer OPERACAO_REGISTRO_ATENDIMENTO_TRAMITAR = new Integer(
			462);
	/** INSERIR PRIORIDADE DO TIPO DE SERVI�O */
	...
	/** INSERIR HISTORICO ALTERA��ES SISTEMA */
	...
	public static final Integer OPERACAO_FUNCIONARIO_ATUALIZAR = new Integer(
			872);
	/** EFETUAR RESTABELECIMENTO DA LIGAÇÃO DE �GUA COM INSTALA��O DE HIDR�METRO */
	...
	public static final Integer OPERACAO_CLIENTE_TIPO_REMOVER = new Integer(
			952);
    ...
    public static final Integer OPERACAO_EMITIR_2_VIA_CONTA_SEM_TAXA = 759;
    public static final Integer OPERACAO_EMITIR_2_VIA_CONTA_COM_TAXA = 304;
    public static final Integer OPERACAO_INFORMAR_PARAMETRO_SISTEMA = 733;
    public static final Integer OPERACAO_INFORMAR_PARAMETRO_SISTEMA_FATURAMENTO_TARIFA_SOCIAL = 736;
    public static final Integer OPERACAO_INFORMAR_PARAMETRO_SISTEMA_ARRECADACAO_FINANCEIRO = 738;
    public static final Integer OPERACAO_INFORMAR_PARAMETRO_SISTEMA_MICROMEDICAO_COBRANCA = 744;
    public static final Integer OPERACAO_INFORMAR_PARAMETRO_SISTEMA_ATENDIMENTO_PUBLICO_SEGURANCA = 746;
    public static final Integer OPERACAO_INFORMAR_PARAMETRO_SISTEMA_DADOS_GERAIS_EMPRESA = 951;
}
